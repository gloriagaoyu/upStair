...
cc._RF.push(module, '1c1d9uNacpIoLKQiZQGQSIe', 'game', __filename);
// Script/game.js
...
cc.Class({
    ...
    newFirstStair: function newFirstStair() {
    ...
    newOtherStair: function newOtherStair(randomNum) {
    ...
    playTyMusic: function playTyMusic() {
        this.tyAudioSource.play();
    },

    playerMove: function playerMove(toRight) {
    ...
    checkMoveIsRight: function checkMoveIsRight(toLeft, nextStairPos) {
    ...
    gameOverThen: function gameOverThen() {
